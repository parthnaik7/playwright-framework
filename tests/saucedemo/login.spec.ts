...
test.describe('SauceDemo — Login', () => {
  ...
  test(
    'should login successfully with valid standard user credentials @smoke @regression',
    async ({ loginPage, inventoryPage, standardCredentials }) => {
  ...
  test(
    'should show error message for locked-out user @regression',
    async ({ loginPage, lockedCredentials }) => {
  ...
  test(
    'should show error for invalid username and password @regression',
    async ({ loginPage }) => {
  ...
  test(
    'should show error when only username is provided @regression',
    async ({ loginPage }) => {
  ...
  test(
    'should show error when only password is provided @regression',
    async ({ loginPage }) => {
  ...
  test(
    'should show error when submitting empty form @regression',
    async ({ loginPage }) => {
  ...
  test(
    'should be able to dismiss error message @regression',
    async ({ loginPage, lockedCredentials }) => {
  ...
  test(
    'should display all login page elements correctly @regression',
    async ({ loginPage }) => {
...
test.describe('SauceDemo — Logout', () => {
  test(
    'should logout successfully from the inventory page @regression',
  ...
  test(
    'should not be able to access inventory page after logout @regression',
    async ({ authenticatedPage, loginPage }) => {
      const { InventoryPage } = await import('../../src/pages/InventoryPage');
      const inventoryPage = new InventoryPage(authenticatedPage);
